...
function get_headerbanner() {
	...
	<div class="headerbanner">
		<div class="oa-banner-brand">
			<a class="oa-banner-title" href="index.php">OpenAudit Classic - <?php echo htmlspecialchars(strtoupper($_SERVER['SERVER_NAME']), ENT_QUOTES, 'UTF-8'); ?></a>
		</div>
	<?php
}
