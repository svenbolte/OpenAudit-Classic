...
echo '<p>Die Liste kann ggf. nach Inventrarisierung des Printservers über die <a target="_blank" href="./ip-list-from-printers.php">Netzwerkdrucker erzeugt werden</a></p>';
